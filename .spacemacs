...
;; set our layers for different platforms here
(setq
 ;; layers to load on all operating systems
 general-layers
 '(
   helm
 ...
 ;; layers to be loaded on windows
 windows-layers
 '(
   (shell :variables
 ...
 ;; layers to be loaded on linux distros
 linux-layers
 '(
   (shell :variables
          shell-default-shell 'multi-term
...
(setq all-layers general-layers)

;; set layers per platform
(cond ((eq system-type 'windows-nt)
       (setq all-layers (append all-layers windows-layers)))
      ((eq system-type 'darwin)
       (setq all-layers (append all-layers osx-layers)))
      ((eq system-type 'gnu/linux)
       (setq all-layers (append all-layers linux-layers))))
...
values."
  (setq-default
   ...
   dotspacemacs-configuration-layers all-layers
